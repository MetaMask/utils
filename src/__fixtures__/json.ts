...
const ARRAY_PROXY_PROXY = new Proxy(ARRAY_PROXY, {});

const OBJECT_PROXY = new Proxy(
  {},
  {
...
export const JSON_VALIDATION_FIXTURES = [
  ...
  {
    value: REVOKED_ARRAY_PROXY.proxy,
    valid: false,
    size: 0,
  },
  {
  ...
  {
    value: REVOKED_OBJECT_PROXY.proxy,
    valid: false,
    size: 0,
  },
  {
